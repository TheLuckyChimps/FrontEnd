      ...
      <div className="reccommendations">
        ...
        <div className="aboutus--info" style={{ textIndent: "50px" }}>
          <p>
            ...
            municipiului Suceava, în urma intrării în faliment a fostei
            societăţi de transport SC TPS SA. La înfiinţare SC TPL SA a preluat
            o parte dintre salariaţii fostei societăţi precum şi parcul auto
